          ...
          <div className={`transition-all duration-300 ${gridClass}`}>
            {paginatedProducts.map((p, idx) => (
              ...
              >
                ...
                {/* Product Information */}
                <div className="p-2.5 flex flex-col justify-between flex-1 gap-1 bg-gradient-to-b from-[#332A06] to-[#1A1503]">
                  <div>
                    <div className="flex justify-between items-start gap-1">
                      ...
                      {p.productCode && (
                        <span className="text-[11px] sm:text-xs text-yellow-300 bg-yellow-400/20 border border-yellow-400/40 px-1.5 py-0.5 rounded font-mono font-black shrink-0">
                          {p.productCode}
                        </span>
                      )}
                    </div>
                  ...
                  {/* Pricing and Pieces */}
                  <div className="pt-1 border-t border-yellow-500/15 flex items-end justify-between">
                    <div>
                      <p className="text-yellow-300 font-bold text-xs font-mono">
